    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-8 py-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="font-display text-2xl font-bold">Semua Course</h1>
            <p className="text-muted-foreground">Kelola semua course di platform</p>
          </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-muted-foreground mb-4">
              {searchQuery ? "Tidak ada course yang cocok dengan pencarian" : "Mulai dengan membuat course pertama"}
            </p>
            {!searchQuery && (
              <Button onClick={() => setShowCreateDialog(true)}>
                <Plus className="mr-2 h-4 w-4" />
